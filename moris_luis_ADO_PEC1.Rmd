...
top_sex = topTable(cm, coef='male_vs_female', adjust='fdr', number=100, sort.by = 'p')
top_res_vs_ses = topTable(cm, coef='res_vs_sens', adjust='fdr', number=100, sort.by = 'p')
top_int = topTable(cm, coef='int_sex_resvssens', adjust='fdr', number=100, sort.by = 'p')
```
...
geneSymbols <- suppressMessages(select(drosophila2.db, rownames(cm), c("SYMBOL")))
...
```{r venn_diagramecho=FALSE, fig.fullwidth = TRUE, out.width='100%', fig.height=6, fig.width=6, out.height='100%', fig.cap='Venn Diagram showing how many genes are significant in each of the contrasts and their intersections.'}
