...
```{r plot_log_data, echo=FALSE, fig.cap="Array Quality Metrics Output",fig.fullwidth = TRUE}
...
```{r show_AQM_rma, echo=FALSE, fig.cap="Array Quality Metrics Output",fig.fullwidth = TRUE}
...
Estamos ante um diseño de 3x2, en este caso vamos a simular que estamos interesados en las comparaciones:
...
contrast_matrix = makeContrasts(res_vs_sens = resistant_female + resistant_male - sensitive_female - sensitive_male, #Regardless of sex
                                male_vs_female = resistant_female + control_female + sensitive_female - (resistant_male + control_male + sensitive_male), # ME of sex
...
top_int = topTable(cm, coef='int_sex_resvssens', adjust='fdr')
```
...
top_int = annotatedTopTable(top_int, anotPackage = 'drosophila2.db')
top_res_vs_ses = annotatedTopTable(top_res_vs_ses, anotPackage = 'drosophila2.db')
